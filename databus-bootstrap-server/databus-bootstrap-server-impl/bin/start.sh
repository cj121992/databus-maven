...
if [ -z "${JVM_OPTS}" ] ; then
	JVM_OPTS="-Xms1024M -Xmx2048M -Djava.awt.headless=true -XX:MaxPermSize=64M"
fi		
...
APP_MAINCLASS=com.linkedin.databus.bootstrap.server.BootstrapHttpServer
...
#JAVA_PARAMS="-Dconf_server_host=10.0.0.81:9061 -Ddisconf.enable.remote.conf=true -Ddisconf.version=1_0_0_0 -Ddisconf.app=module_app -Ddisconf.env=rd -Ddisconf.user_define_download_dir=./disconf/download2"
