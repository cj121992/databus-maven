...
public class HttpServerPipelineFactory implements ChannelPipelineFactory
{
    ...
    public ChannelPipeline getPipeline() throws Exception
    {
      ...
      /*  NettyStats nettyStats = _serverContainer.getNettyStats();
        ...
        //add executerHandler,优化耗时较长的hanlder处理,这之后的handler处理呗ExecHanlder中的线程池操作,释放worker线程(worker线程的handler处理是同步的)
        pipeline.addLast("executionHandler", _serverContainer.getNettyExecHandler());
        
        //继承simpleUpstreamhandler,覆盖messageReceived方法,如果是databus组建的请求
