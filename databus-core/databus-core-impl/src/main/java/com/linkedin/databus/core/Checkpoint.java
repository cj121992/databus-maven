	...
	implements Serializable, Cloneable
{
  ...
  private static final String CLIENT_SKIP_WTE = "clientSkipWTE";
  ...
  private void mapToInternalState()
  {
    ...
    clientSkipWTE = (internalData.get(CLIENT_SKIP_WTE) != null) ?  (boolean) internalData.get(CLIENT_SKIP_WTE) : false;
  }
  ...
  private void internalStateToMap( )
  {
    ...
    internalData.put(CLIENT_SKIP_WTE, clientSkipWTE);
  }
  ...
  private void assertCatchupSourceIndex()
  {
	...
	public boolean isClientSkipWTE() {
		return clientSkipWTE;
	}

	public void setClientSkipWTE(boolean clientSkipWTE) {
		this.clientSkipWTE = clientSkipWTE;
	}
