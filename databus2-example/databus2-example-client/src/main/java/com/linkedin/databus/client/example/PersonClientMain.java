...
{
  static final String PERSON_SOURCE = "com.linkedin.events.example.appstable.UserRelation";
  //static final String PERSON_SOURCE = "com.linkedin.events.example.pg_test.Person";
  ...
  public static void main(String[] args) throws Exception
  {
   ...
   // PersonConsumerPg personConsumer = new PersonConsumerPg();
    RelationConsumer relationConsumer = new RelationConsumer();
    //PersonConsumer personConsumer = new PersonConsumer();
    client.registerDatabusStreamListener(relationConsumer, null, PERSON_SOURCE);
    client.registerDatabusBootstrapListener(relationConsumer, null, PERSON_SOURCE);
